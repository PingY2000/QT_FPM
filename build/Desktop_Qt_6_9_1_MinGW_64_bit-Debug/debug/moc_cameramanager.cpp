...
template <> constexpr inline auto CameraManager::qt_create_metaobjectdata<qt_meta_tag_ZN13CameraManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'stillImageArrived'
        QtMocHelpers::SignalData<void()>(5, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'exposureChanged'
        QtMocHelpers::SignalData<void()>(6, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'EventCallback'
        QtMocHelpers::SlotData<void(unsigned , void *)>(7, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::UInt, 8 }, { QMetaType::VoidStar, 9 },
        }}),
    };
...
void CameraManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->imageArrived(); break;
        case 2: _t->stillImageArrived(); break;
        case 3: _t->exposureChanged(); break;
        case 4: _t->EventCallback((*reinterpret_cast< std::add_pointer_t<uint>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<void*>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CameraManager::*)(const QImage & )>(_a, &CameraManager::imageReady, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (CameraManager::*)()>(_a, &CameraManager::imageArrived, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (CameraManager::*)()>(_a, &CameraManager::stillImageArrived, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (CameraManager::*)()>(_a, &CameraManager::exposureChanged, 3))
            return;
    }
}
...
// SIGNAL 0
void CameraManager::imageReady(const QImage & _t1)
{
